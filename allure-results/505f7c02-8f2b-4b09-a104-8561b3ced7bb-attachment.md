...
Expected substring: "account/account"
Received string:    "http://localhost/opencart/upload/index.php?route=account/login"
```
...
```ts
  ...
  16 |     });
  17 | 
  18 |     test('should login successfully with valid credentials', async ({page}) => {
  19 | 
